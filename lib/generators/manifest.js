...
// entry="WatchFaceApp" must match garmin-project-template/manifest.xml and the
// App class in lib/generators/monkeyc.js. Update all three locations together.

const crypto = require('crypto');
const { DEVICE_ID, MIN_API_LEVEL } = require('../../src/constants/device');

function generateManifest(permissions) {
