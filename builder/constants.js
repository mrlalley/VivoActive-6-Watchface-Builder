/**
 * @fileoverview Application constants (browser-friendly ES6 modules)
 * Mirrors src/constants/ but in a format that works with browser ES6 imports.
 */
...
export const SAFE_AREA_DIAMETER = 370;
export const SAFE_AREA_RADIUS = 185;
export const EDGE_WARN_DISTANCE = 20;
export const MIN_ELEMENT_SIZE = 20;
export const MAX_DESIGN_ELEMENTS = 200;
export const LAUNCHER_ICON_SIZE = 54;
export const TARGET_API_LEVEL = '6.0';
export const MIN_API_LEVEL = '4.2.0';
export const DEVICE_ID = 'vivoactive6';
