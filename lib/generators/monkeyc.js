...
// Single source of truth for valid fonts lives in validation.js.
// Import the array and wrap in a Set for O(1) lookups in this file.
const { VALID_FONTS: VALID_FONTS_ARRAY } = require('../validation');
const VALID_FONTS = new Set(VALID_FONTS_ARRAY);

// Shape types actually handled by generateDrawCall (unknown types fall through
// to text rendering and produce silent bad output without this guard).
