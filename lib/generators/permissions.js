...
const PERMISSION_MAP = {
  ...
  // SensorHistory API — requires Sensor permission
  hrGraph:          'Sensor',
  spo2:             'Sensor',
  respirationRate:  'Sensor',
  hrvStatus:        'Sensor',
  bodyBattery:      'Sensor',
  stressLevel:      'Sensor',
...
function getRequiredPermissions(elements) {
  ...
  // For watch faces, 'Sensor' permission requires 'Background' permission
  if (perms.has('Sensor')) {
    perms.add('Background');
  }
