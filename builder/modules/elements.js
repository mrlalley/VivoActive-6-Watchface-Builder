...
const IMPORT_VALID_SHAPE_TYPES = new Set(VALID_SHAPE_TYPES);
const IMPORT_VALID_ALIGNS = new Set(VALID_ALIGNS);
const IMPORT_VALID_VISIBILITY = new Set(VALID_VISIBILITY);
