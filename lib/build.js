 ...
 */
async function buildProject(cfg, projectName, elements, requestId = null, background = null) {
  ...
  try {
    ...
    generateProjectFiles(elements, projectName, requestCfg, background);
  ...
  return new Promise((resolve) => {
    ...
    child.on('close', (code, signal) => {
      ...
      try {
        fs.writeFileSync(designTmp, JSON.stringify({ projectName, elements, background }, null, 2));
